            ...
            <header className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center shadow-2xl roun">
                    ...
                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center font-bold">
                        <Link href={'/'} className="mx-3 md:mx-0 md:mr-5 hover:text-gray-900 hover:bg-pink-400 py-1 px-2 rounded-2xl">Home</Link>
                        <Link href={'/about'} className="mx-3 md:mx-0 md:mr-5 hover:text-gray-900 hover:bg-pink-400 py-1 px-2 rounded-2xl">About</Link>
                        <Link href={'/blog'} className="mx-3 md:mx-0 md:mr-5 hover:text-gray-900 hover:bg-pink-400 py-1 px-2 rounded-2xl">Blog</Link>
                        <Link href={'/contact'} className="mx-3 md:mx-0 md:mr-5 hover:text-gray-900 hover:bg-pink-400 py-1 px-2 rounded-2xl">Contact</Link>
                    </nav>
                    {!user.value && <div className='flex items-center justify-center'>
                        ...
                        <Link href={'/login'} className="ml-3 inline-flex items-center bg-pink-400 border-0 py-1 px-3 focus:outline-none hover:bg-pink-500 rounded text-base mt-4 md:mt-0 text-white">Login
                            ...
                            <button onMouseOver={onover} onMouseLeave={onleave} className="absolute md:top-10 right-10 md:static inline-flex items-center mt-4 md:mt-0 text-pink-400 hover:text-pink-500 text-3xl"><RiAccountCircleFill />
                            </button>
                            {dropdown && <div id='account' className='absolute top-[8.7rem] right-10 md:top-12 md:right-28 z-20 bg-pink-200 rounded-2xl' onMouseOver={onover} onMouseLeave={onleave}>
